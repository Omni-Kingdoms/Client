  ...
  return (
    <div className="fixed z-50 inset-0 overflow-y-auto">
      <div className="fixed inset-0 backdrop-blur-sm flex items-center justify-center">
        <div ref={trainingRef} className="bg-modal relative flex flex-col min-w-[440px] max-w-[100vw]">
          ...
          <div className="content absolute inset-0 px-12 py-32 flex flex-col gap-4 p-[15%] md:py-24 md:px-24 sm:gap-10">
            <div className="flex gap-4 md:gap-10">
              ...
              <div style={{ flex: 2 }} className="mt-10 flex flex-col items-start gap-2">
                ...
                <div>
                  <p className="text-describle max-w-[330px]">{width >= 768 ? text : (mobileText || text)}</p>
                </div>
